    ...
    return (
      <>
        ...
        <form onSubmit={this.handleFormSubmit} id="portfolio" className="fade-in">
          ...
          <div className="form-group">
            <label className="label-txt" htmlFor="input-nameStudio">Estudio de arquitectura</label>
            <input
              name="nameStudio"
              type="text"
              className="form-control"
          ...
          <div className="form-group">
            <label className="label-txt" htmlFor="input-address">Dirección</label>
            <input
              name="address"
              type="text"
              className="form-control"
          ...
          <div className="form-group">
            <label className="label-txt" htmlFor="input-mail">Email</label>
            <input
              name="mail"
              type="text"
              className="form-control"
          ...
          <div className="form-group">
            <label className="label-txt" htmlFor="input-phone">Phone</label>
            <input
              name="phone"
              type="number"
              className="form-control"
          ...
          <div className="form-group">
            <label className="label-txt" htmlFor="input-img">Añade tus principales proyectos</label>
            <input
              name="imageUrl"
              type="file"
              multiple="multiple"
