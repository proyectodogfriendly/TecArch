            ...
            <div className="row">
                <div className="col-8">
                    <article className="compet-card">
                        ...
                        <Link className="btn btn-sm btn-tecarch5" to={`/competitions/${_id}`}>Añadir propuesta</Link>
                        <Link className="btn btn-sm btn-tecarch5" to={`/competitions/${_id}`}>Ver propuestas</Link>
