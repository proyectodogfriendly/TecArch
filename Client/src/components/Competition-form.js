  ...
  render() {
    return (
     ...
     <br></br><br></br>
        ...
        <form onSubmit={this.handleFormSubmit} className="fade-in" id="formuComp">
          <div className="row">
              <div className="col-6">
              ...
              <div className="col-6">
              <div className="form-group">
                <label className="label-txt" htmlFor="input-phone">Presupuesto</label>
                <input
                  name="amount"
                  type="number"
                  className="form-control"
          ...
          <div className="row">
            ...
            <div className="col-6">
              <div className="form-group">
                  <label className="label-txt" htmlFor="input-address">Provincia</label>
                  <input
                    name="address"
                    type="text"
                    className="form-control"
